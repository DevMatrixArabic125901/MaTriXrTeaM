...
local UserName = (data.username_ or "MaTTeaM")
...
if text == '/start' then  
local url,res = https.request('https://ahmed.MaTTeaM.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MaTTeaM ~= true then
...
os.execute('rm -rf MaTriX.lua')
os.execute('wget https://raw.githubusercontent.com/qithoniq/MaTTeaM/main/MaTriX.lua')
...
send(msg.chat_id_, msg.id_,'≭︰اهلا بك عزيزي\n≭︰ان كان لديك استفسار او اي مشكلة\n≭︰يمكنك مراسلة مطور السورس\n≭︰حساب مطور السورس [ꪎ 𓏺 𝖠𝗁𝖬𝖾𝖣 𓏺 ꪎ](https://t.me/lsbax_dev)
end

if text == 'تحديث المتجر ≭' and Devahmed(msg) then 
io.popen("mkdir File_Bot")
os.execute("rm -fr File_Bot/*")
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MaTTeaM/Files_ahmed/main/File_Bot/all.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MaTTeaM/Files_ahmed/main/File_Bot/Reply.lua")  
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MaTTeaM/Files_ahmed/main/File_Bot/games.lua") 
send(msg.chat_id_, msg.id_,'≭︰اهلا بك عزيزي\n≭︰تم تنزيل جميع ملفات المتجر وتحديثه الى اخر اصدار\n≭︰تابعنا لتصلك اخر التحديثات\n≭︰[قناة السورس](t.me/MaTTeaM)')
dofile('MaTriX.lua')  
end
...
{{text = '📂┇𝚆𝙰𝚃𝙰𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/MaTTeaM"}},
}
...
usertext = '\n≭︰العضو › ['..result.title_..'](t.me/'..(username or 'MaTTeaM')..')'
status  = '\n≭︰تم ترقيته مطور'
...
usertext = '\n≭︰العضو › ['..data.first_name_..'](t.me/'..(data.username_ or 'MaTTeaM')..')'
status  = '\n≭︰تم ترقيته مطور'
...
if ahmed1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'≭︰العضو › ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'MaTTeaM')..') \n≭︰'..ahmed1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ≭︰العضو : {["..data.first_name_.."](t.me/MaTTeaM)}\n≭︰["..ahmed_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ≭︰عذرا › {["..data.first_name_.."](t.me/MaTTeaM)}\n≭︰عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = "[‹ Welcome to Source ›](t.me/MaTTeaM)\n[‹ Source ahmed ›](t.me/MaTTeaM)\n‹ Source version : 4.7 ›"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '‹ Source ahmed ›',url="t.me/MaTTeaM"},
{text = '‹ Exp ahmed ›',url="t.me/Exp_ahmed"}},
{{text = '‹ developer ›',url="t.me/lsbax_dev"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MaTTeaM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'≭︰بواسطه › ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'MaTTeaM')..') \n≭︰تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'≭︰بواسطه › ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'MaTTeaM')..') \n≭︰تـم قفـل التاك بالكتم ')
end,nil)   
...
if Devahmed(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MaTTeaM/Files_ahmed/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n≭︰اهلا بك في متجر ملفات ماتركس\n≭︰ملفات السورس ↓\nٴ--  --  --  --  --  --  --  --ٴ\n\n"
local TextE = "\nٴ--  --  --  --  --  --  --  --ٴ\n≭︰علامة تعني { ✔️ } ملف مفعل\n≭︰علامة تعني { ✖ } ملف معطل\n≭︰قناة سورس ماتركس ↓\n".." ≭︰[اضغط هنا لدخول](t.me/MaTTeaM) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/MaTTeaM/Files_ahmed/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n≭︰لعضو › ['..data.first_name_..'](t.me/'..(data.username_ or 'MaTTeaM')..')'
status  = '\n≭︰تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n≭︰العضو › '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n≭︰العضــو › ['..data.first_name_..'](t.me/'..(data.username_ or 'MaTTeaM')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n≭︰العضو › ['..result.title_..'](t.me/'..(text1[3] or 'MaTTeaM')..')'..'\n≭︰تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/Song'}},{{text='‹ source ahmed ›',url="t.me/source_ahmedr"}
}
}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/animation'}},{{text='‹ source ahmed ›',url="t.me/source_ahmedr"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/voice'}},{{text='‹ source ahmed ›',url="t.me/source_ahmedr"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/rapp'}},{{text='‹ source ahmed ›',url="t.me/source_ahmedr"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/Memz'}},{{text='‹ source ahmed ›',url="t.me/source_ahmedr"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/Remix'}},{{text='‹ source ahmed ›',url="t.me/source_ahmedr"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/Movies'}},{{text='‹ source ahmed ›',url="t.me/source_ahmedr"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/Anime'}},{{text='‹ source ahmed ›',url="t.me/source_ahmedr"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/Photos'}},{{text='‹ source ahmed ›',url="t.me/source_ahmedr"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender_id.user_id..'/Series'}},{{text='‹ source ahmed ›',url="t.me/source_ahmedr"}
}
}
local msg_id = msg.id/2097152/0.5
...
database:set(bot_id.."MaTTeaM:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'➫✿ تم تفعيل الانستا')
database:set(bot_id.."MaTTeaM:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."MaTTeaM:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."MaTTeaM:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"≭︰تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."MaTTeaM:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."MaTTeaM:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'MaTTeaM')..')'
local iduser = result.sender_user_id_
